...
// If you click on the read more, you see the ID which it is associated with (eg. movie 4 on the page will show you ID 4 when clicked)
// echo $_GET['id'];
// exit;
...
<body>
    ...
    <?php if(!is_string($getMovie)):?>
        <?php while($row = $getMovie->fetch(PDO::FETCH_ASSOC)):?>
            <img src="images/<?php echo $row['movies_cover'];?>" alt="<?php echo $row['
                movies_title']?>"/>
